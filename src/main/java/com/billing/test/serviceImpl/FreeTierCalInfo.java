...
//	Global-DataTransfer-Out-Bytes
	...
	public static BigDecimal FreeTierApply(AwsComDefaultVO pvo, String usagetype, BigDecimal beginRange, BigDecimal endRange, BigDecimal intervalAmount,Map<String,BigDecimal> getFreeTierList) {
...
//		BigDecimal freeBeginRange			= new BigDecimal("0");	//프리티어 사용최소범위는 0으로 전제함
	...
	//프리티어로 인해 절감될 interval Amount 계산	(endRange == Inf)
	public static BigDecimal FreeTierApply(AwsComDefaultVO pvo, String usagetype, BigDecimal beginRange, BigDecimal intervalAmount, Map<String,BigDecimal> getFreeTierList) {
		Map<String,BigDecimal> freeTierList = getFreeTierList;
		BigDecimal freeEndRange				= new BigDecimal("0");	//프리티어 사용최대범위
		BigDecimal reduceAmount				= new BigDecimal("0");  //프리티어로 인한 절감량
